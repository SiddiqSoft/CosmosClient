...
This directory contains helper scripts to simplify building and testing the CosmosClient project.
...
# Run with defaults (debug build, auto-detect platform)
./build_and_test.sh

# Specify build type and platform
./build_and_test.sh debug macos
./build_and_test.sh release linux
